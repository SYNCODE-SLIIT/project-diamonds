...
import { createChatGroup, updateChatGroupMembers, deleteChatGroup, getChatGroupsForUser, getAllChatGroups, getGroupMembers, addMembersToGroup, removeMemberFromGroup, getChatGroupById } from '../controllers/chatGroupController.js';
...
// Get details of a single chat group
router.get('/:groupId', getChatGroupById);
