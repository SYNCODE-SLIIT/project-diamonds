...
const Home = () => {
  ...
  useEffect(() => {
    // Process TikTok embeds after render
  ...
  // Modify your useEffect for loading social media scripts
  useEffect(() => {
    ...
    .then(() => {
      // Explicitly process TikTok embeds after scripts are loaded
      if (window.TikTok) {
        window.TikTok.embeds.process();
      }
    })
...
<div className="bg-gray-100 p-6 rounded-lg shadow-md">
  ...
  <div className="youtube-container w-full h-96 bg-gray-200 rounded overflow-hidden">
    <img 
      src={assets.youtube} // Replace with a YouTube channel image from your assets
      alt="Team Diamonds YouTube Channel" 
      className="w-full h-full object-cover"
    />
  </div>
  
  <a  href="https://www.youtube.com/@Teamdiamondsmanagement/videos"
    target="_blank"
    rel="noopener noreferrer"
    className="block text-center mt-4 text-blue-600 font-semibold hover:text-blue-800"
  >
...
<div className="bg-gray-100 p-6 rounded-lg shadow-md">
  ...
  <div className="tiktok-container w-full bg-gray-200 rounded overflow-hidden">
    <blockquote 
      className="tiktok-embed" 
      cite="https://www.tiktok.com/@team.diamonds.official" 
      data-unique-id="team.diamonds.official" 
      data-embed-type="creator" 
      style={{maxWidth: "100%"}}
    >
      <section>
        <a target="_blank" rel="noopener noreferrer" href="https://www.tiktok.com/@team.diamonds.official?refer=creator_embed">@team.diamonds.official</a>
      </section>
    </blockquote>
  </div>
  
  <a  href="https://www.tiktok.com/@team.diamonds.official"
    target="_blank"
    rel="noopener noreferrer"
    className="block text-center mt-4 text-blue-600 font-semibold hover:text-blue-800"
  >
