  ...
  <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-red-50 via-white to-red-100 p-4">
    <div className="bg-white shadow-2xl rounded-2xl p-10 flex flex-col items-center max-w-md w-full">
      ...
      <div className="flex flex-col gap-3 w-full">
        ...
        <a href="/events/annual-gala-fundraiser" className="w-full bg-white border border-red-300 text-red-600 py-3 rounded-xl text-center font-semibold shadow hover:bg-red-50 transition">Try Payment Again</a>
      </div>
...
export default TicketPaymentCancel; 